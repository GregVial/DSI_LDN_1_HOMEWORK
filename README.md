# DSI 1 Student Homework Repository

Welcome to the GA London DSI 1 student homework repository. This is the place we are going to monitor the completion of your homework.
...
Add the title of homework to the pull request, e.g. "Python data types w01d02".
